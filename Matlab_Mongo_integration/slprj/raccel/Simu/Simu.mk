...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Simu_ref.rsp
COMPILER_COMMAND_FILE     = Simu_comp.rsp
...
rt_logging_simtarget.obj : $(MATLAB_ROOT)\rtw\c\src\rt_logging_simtarget.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\rtw\c\src\rt_logging_simtarget.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\rtw\c\src\rt_logging_simtarget.c
